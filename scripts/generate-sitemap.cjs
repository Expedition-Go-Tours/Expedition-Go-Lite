...
const STATIC_PAGES = [
  ...
  { path: '/transport', priority: 0.5, changefreq: 'monthly' },
  { path: '/transport-providers', priority: 0.3, changefreq: 'monthly' },
  { path: '/hotels', priority: 0.3, changefreq: 'monthly' },
  { path: '/travel-agents', priority: 0.3, changefreq: 'monthly' },
  { path: '/content-creators', priority: 0.3, changefreq: 'monthly' },
  ...
  { path: '/supplier-terms', priority: 0.2, changefreq: 'yearly' },
];
...
async function main() {
  ...
  try {
    const data = await fetchJson(`${API_URL}/api/expedition/tours/sitemap`);
    ...
    const listData = await fetchJson(`${API_URL}/api/expedition/tours?limit=50`);
