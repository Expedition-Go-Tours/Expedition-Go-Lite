...
import paypalSrc from '../assets/icons/paypal2.svg'
import jcbSrc from '../assets/icons/jcblogo.svg'
      ...
      <div className="footer-container">
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <a href="#" className="footer-link" onClick={(e) => e.preventDefault()}>{t('footer.blog')}</a>
          ...
          <div className="footer-col">
            <h4 className="footer-heading">{t('footer.connectWithUs')}</h4>
            <div className="footer-socials">
              <a href="https://api.whatsapp.com/message/TEG6KQTQPK2IK1?autoload=1&app_absent=0" target="_blank" rel="noopener noreferrer" className="footer-social footer-social--whatsapp" aria-label="WhatsApp">
              ...
              <a href="https://www.instagram.com/expeditiongotours" target="_blank" rel="noopener noreferrer" className="footer-social footer-social--instagram" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/p/Expedition-Go-Tours-LTD-61567042001418/" target="_blank" rel="noopener noreferrer" className="footer-social footer-social--facebook" aria-label="Facebook">
