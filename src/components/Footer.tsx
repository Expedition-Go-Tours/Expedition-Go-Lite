        ...
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <div className="footer-socials">
              <a href="#" onClick={(e) => e.preventDefault()} className="footer-social footer-social--whatsapp" aria-label="WhatsApp">
              ...
              <a href="#" onClick={(e) => e.preventDefault()} className="footer-social footer-social--instagram" aria-label="Instagram">
              ...
              <a href="#" onClick={(e) => e.preventDefault()} className="footer-social footer-social--youtube" aria-label="YouTube">
              ...
              <a href="#" onClick={(e) => e.preventDefault()} className="footer-social footer-social--tiktok" aria-label="TikTok">
              ...
              <a href="#" onClick={(e) => e.preventDefault()} className="footer-social footer-social--facebook" aria-label="Facebook">
