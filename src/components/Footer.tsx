      ...
      <div className="footer-container">
        <div className="footer-grid">
          <div className="footer-col">
            ...
            <a href="#" className="footer-link">Get in touch</a>
          ...
          <div className="footer-col">
            ...
            <div className="footer-socials">
              <a href="#" className="footer-social footer-social--whatsapp" aria-label="WhatsApp">
              ...
              <a href="#" className="footer-social footer-social--instagram" aria-label="Instagram">
              ...
              <a href="#" className="footer-social footer-social--youtube" aria-label="YouTube">
              ...
              <a href="#" className="footer-social footer-social--tiktok" aria-label="TikTok">
              ...
              <a href="#" className="footer-social footer-social--facebook" aria-label="Facebook">
