...
const TOC = [
  ...
  { id: '15-privacy-and-use-of-information-across-the-expedition-go-tours-ecosystem', num: '15', label: 'Privacy and use of information across the Expedition-Go Tours ecosystem' },
    ...
    <main style={{ paddingTop: 60, background: '#f7f7f3' }}>
      ...
      <section className="leg-wrap leg-hero">
        <div>
          ...
          <p>The agreement governing access to and use of Expedition-Go Tours and its connected booking services.</p>
      ...
      <div className="leg-wrap leg-layout">
        <aside className="leg-sidebar">
          ...
          <div className="leg-helpbox">
            <b>Need help?</b>
            <p>Questions about this document or your relationship with Expedition-Go?</p>
        ...
        <div className="leg-content">
          ...
          <p>Where Expedition-Go Tours operates the Experience directly, your contract for the Experience is with Expedition-Go Tours.</p>
          <p>Where an independent Supplier operates the Experience, Expedition-Go Tours provides booking, payment collection, customer-support and marketplace services and may act as the Supplier&apos;s disclosed commercial agent. Unless the booking page states otherwise, the contract for delivery of that Experience is between you and the Supplier. The Supplier remains responsible for performing the Experience safely, lawfully and substantially as described.</p>
          <p>Independent Suppliers are not employees of Expedition-Go Tours. Nothing in these Terms removes any responsibility that Expedition-Go Tours has under applicable law or for services it directly provides.</p>
          ...
          <p>You retain ownership of your User Content but grant Expedition-Go Tours a worldwide, non-exclusive, royalty-free licence to host, reproduce, adapt for formatting, translate, publish and display it for operating and promoting the Platform and Experiences. This licence ends when the content is deleted from our systems, except for content already used in lawful published materials or retained where legally required.</p>
          ...
          <ul>
            <li>Expedition-Go Tours is responsible for losses that are a reasonably foreseeable result of its breach of these Terms or failure to exercise reasonable care and skill;</li>
            <li>Expedition-Go Tours is not responsible for loss caused by your breach, failure to follow instructions, inaccurate information or failure to obtain required travel documents;</li>
            <li>where an independent Supplier provides the Experience, that Supplier is principally responsible for its performance, acts and omissions, although this does not remove any separate duty owed by Expedition-Go Tours; and</li>
            <li>Expedition-Go Tours is not liable for indirect or consequential business loss, loss of profit, loss of opportunity or loss of data arising from personal consumer use of the Platform.</li>
          </ul>
          ...
          <p>You and Expedition-Go Tours should first attempt to resolve a dispute through the complaint process in Section 13. If it cannot be resolved, the courts of competent jurisdiction in Ghana will have jurisdiction, except where mandatory consumer law permits you to bring proceedings elsewhere.</p>
