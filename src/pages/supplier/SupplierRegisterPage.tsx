...
const HERO_IMAGES = [
  { src: 'https://www.expeditiongotours.com/assets/login-CVCOiS3v.png', alt: 'Supplier login screen', cls: 'le-phone-a' },
  { src: 'https://www.expeditiongotours.com/assets/dashboard-gdPjqAgj.png', alt: 'Supplier dashboard with bookings and earnings', cls: 'le-phone-b' },
  { src: 'https://www.expeditiongotours.com/assets/products-BQ2_Qx8G.png', alt: 'Tour products management screen', cls: 'le-phone-c' },
]
...
const FAQ_ITEMS = [
  ...
  { question: 'How are activities promoted?', answer: 'Eligible tours can be promoted through the Expedition-Go website, social channels, email, blog content and relevant partner distribution channels.' },
  { question: 'What happens after I sign up?', answer: 'Confirm your email, access your supplier portal, add your activity and submit the required business information. The Expedition-Go team then reviews your listing before it goes live.' },
]
      ...
      <section className="le-hero">
        <div className="wrap le-hero-grid">
          <div className="le-hero-copy">
            <div className="le-kicker"><span />Expedition-Go supplier network</div>
          ...
          <div className="le-device-wall" aria-label="Expedition-Go supplier platform screens">
            {HERO_IMAGES.map((img) => (
        ...
        <div className="wrap">
          <RevealOnScroll>
            <div className="le-why-head">
              <div><span className="le-label">Why Expedition-Go Tours</span><h2 className="le-title">Built to help your business grow.</h2></div>
        ...
        <div className="wrap">
          <div className="le-faq-grid">
            <div className="le-faq-side">
              ...
              <a className="le-btn le-btn-primary" href="https://www.expeditiongotours.com/help-centre">Visit Help Centre</a>
            </div>
            <RevealOnScroll>
        ...
        <div className="wrap">
          <RevealOnScroll>
            <div className="le-cta-inner">
              <div><h2>Ready to list your experience?</h2><p>Join Expedition-Go Tours—it only takes a few minutes to get started.</p></div>
