...
import { useCheckoutDraft, useReleaseCheckoutDraft } from '../hooks/useExpeditionBookings'
...
export default function CheckoutPage() {
  ...
  if (isLoading || (!draft && draftId && !isError)) {
    return (
      <div className="co-page">
        <div className="co-shell co-skeleton">
          <div className="co-skel co-skel-head" />
          <div className="co-body co-grid">
  ...
  const payDisabled = !elementsState.ready || !elementsState.complete || holdExpired || processing
    ...
    <div className="co-page">
      <div className="co-shell">
        ...
        <header className="co-header">
          <button type="button" className="co-back" onClick={handleCancel} aria-label="Back to booking">
            <ArrowLeft size={18} />
            <span>Back</span>
          </button>
        ...
        <div className="co-body co-grid">
          {/* LEFT — order summary (server-authoritative) */}
          <aside className="co-left">
            <div className="co-lockup">
              ...
              <div className="co-total">
                {formatMoney(draft.pricing.total, draft.currency)}
              </div>
            </div>
          ...
          {/* RIGHT — customer + payment + our Pay button */}
          <section className="co-right" aria-label="Payment details">
            {holdExpired ? (
              <div className="co-card">
                ...
                <h2 className="co-section-title">Your hold expired</h2>
                <p className="co-muted">The reserved spot has been released. Start again to rebook before it's gone.</p>
                <div className="co-actions">
                  <Link
                    className="co-btn co-btn-solid"
                    to={`/${encodeURIComponent(draft.tour.slug || draft.tour.id)}/booking`}
                  >
                    Rebook this tour
                  </Link>
                </div>
              ...
              <div className="co-card">
                <h2 className="co-section-title">Payment details</h2>
