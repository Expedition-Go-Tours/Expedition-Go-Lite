        ...
        <div className="wrap ta-hero-grid">
          <div>
            ...
            <p className="ta-hero-copy">
              Offer your clients curated Ghana experiences through Expedition-Go and earn a transparent commission on every confirmed booking — managed from one simple dashboard.
            </p>
      ...
      <div className="wrap" style={{ paddingTop: 20 }}>
        <RevealOnScroll>
          <div className="eg-cta">
            ...
            <p>Join the Expedition-Go travel agent network and earn transparent commission on curated experiences across Ghana.</p>
            <button
              onClick={handleApply}
              style={{
