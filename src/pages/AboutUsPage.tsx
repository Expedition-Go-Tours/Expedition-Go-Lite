    ...
    <MotionConfig reducedMotion="user">
      <div className="about-page">
        ...
        {/* ================================================================
            ...
            ================================================================ */}
        <section className="about-hero" aria-label="About Expedition-Go Tours">
          <div className="about-container about-hero-grid">
            ...
            >
              ...
              <motion.p className="about-hero-lead" variants={cardFade}>
                Expedition-Go Tours connects travellers with authentic, hand-picked
        ...
        <motion.section
          ...
          viewport={revealViewport}
          variants={stagger}
          aria-label="The Expedition-Go difference"
        >
          <div className="about-container">
            <div className="about-promise-shell">
              <motion.div className="about-promise-left" variants={fadeUp}>
                <p className="about-label">The Expedition-Go difference</p>
