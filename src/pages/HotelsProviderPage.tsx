...
const FAQ_ITEMS = [
  ...
  { question: 'How do I contact the partnerships team?', answer: 'For programme enquiries, contact partners@expedition-go.com or use the Expedition-Go Contact Us page.' },
]
        ...
        <div className="wrap hs-hero-grid">
          <div>
            ...
            <p className="hs-hero-copy">
              List your hotel, guesthouse, apartment or resort with Expedition-Go. Manage rooms, rates and reservations while helping travellers experience more of Ghana.
            </p>
