...
export default function ContactUsPage() {
  ...
  const SUPPORT_HOURS = [
    { label: t('contact:hours1Label'), value: t('contact:hours1Value'), closed: false },
    { label: t('contact:hours2Label'), value: t('contact:hours2Value'), closed: false },
  ...
  return (
    <div className="support-page">
      ...
      <div className="support-container">
        ...
        <h2 className="support-section-title">{t('contact:visitUs')}</h2>
        <div className="support-location-card">
          ...
          <div className="support-location-info">
            ...
            <h3 className="support-location-name">{t('contact:companyName')}</h3>
